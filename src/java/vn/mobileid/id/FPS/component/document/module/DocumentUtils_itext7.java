...
public class DocumentUtils_itext7 {
    ...
    public static byte[] createTextField_i7(
        ...
        Paragraph paragraph = new Paragraph(field.getValue())
                .setMargin(0)
...
//        float yCoord = 73;
//
        paragraph.setWidth(field.getDimension().getWidth());
        paragraph.setHeight(field.getDimension().getHeight());
        canvas.showTextAligned(paragraph, field.getDimension().getX(), field.getDimension().getY(), TextAlignment.CENTER);
        canvas.close();
...
//          byte[] result = createTextFormField_i7(pdf, textField, "");
